...
private val params = listOf(
    ...
    ExtractParam(
        ...
        Level.INFO,
        "hi",
        "[message=boom name=TypeError stack=\"TypeError: boom\n    at Object.<anonymous> ...\"]",
    ),
    ...
    ExtractParam(
        ...
        Timestamp.Parsed(Instant.parse("2024-08-13T18:15:05.348Z")),
        Level.INFO,
    ...
    ExtractParam(
        "Serilog Rendered Compact LOGFMT",
...
class ExtractTest : TestCase() {
    fun testExtractTimestamp() {
        params.forEach { param ->
            val node = parseLogLine(param.logfmt)!!
